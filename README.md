...
| :---: | :---: |
| <img src="./ringi-ip-article-illustrations/docs/images/01-rag-retrieval-workflow.jpg" alt="3D RAG Retrieval Workflow" width="460"/> | <img src="./ringi-ip-article-illustrations/docs/images/02-agent-execution-loop.jpg" alt="3D Agent Execution Loop" width="460"/> |
| **RAG 检索增强架构 3D 小剧场** | **Agent 自主执行循环与自愈机制** |

| 🏺 Anthropic 编辑插画 (`ringi-anthropic-art`) | 🌌 GeneTind 空间架构 (`genetind-design`) |
| :---: | :---: |
| <img src="./ringi-anthropic-art/examples/earth.png" alt="Anthropic Hand-drawn Earth" width="460"/> | <img src="./genetind-design/assets/backgrounds/genetind-background-03.png" alt="GeneTind Dark Radial Background" width="460"/> |
...
```mermaid
graph LR
    A["Raw Topic / PRD 原始需求"] --> B["ringi-writing-dna\n高密度硬核长文撰写"]
    B --> C["ringi-article-illustrator\n3D小剧场认知配图"]
